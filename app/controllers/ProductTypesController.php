...
class ProductTypesController extends ControllerBase
{
	public function initialize(){
		$this->tag->stTitle('Manage your products types');
		parent::initialize();
	}
	...
	public function searchAction(){
		...
		$productTypes = ProductsTypes::find($parameters);
	...
	public function editAction($id){
		if(!$this->request->isPost()){
			$producttypes = ProductTypes::findeFirstById($id);
			if(!$producttypes){
				$this->flash->error('Product type to edit was not found');
				return $this->forward('productypes/index');
			}
	...
	public function deleteAction($id){
		...
		$this->flash->success('Product Type was deleted');
		return $this->forward('producttypes/index');
	}
}